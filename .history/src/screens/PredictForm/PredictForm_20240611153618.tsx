...
const field = [
  ...
  { name: "Cout_total_5_usages" },
  { name: "Surface_habitable_logement" },
  { name: "Qualite_isolation_enveloppe" },
  { name: "Type_energie_principale_chauffage" },
  { name: "Type_installation_chauffage" },
  { name: "Code_postal_BAN" },
  { name: "Conso_5_usages_e_finale" },
  { name: "Conso_5_usagesm2_e_finale" },
  { name: "Emission_GES_5_usages" },
  { name: "Emission_GES_5_usages_par_m2" },
  { name: "Cout_chauffage" },
  { name: "Cout_ECS" },
  { name: "Qualite_isolation_menuiseries" },
];
