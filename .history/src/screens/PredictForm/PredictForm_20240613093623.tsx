      ...
      {prediction && (
        ...
        >
          ...
          <div className="result-prediction">
            <div className="result-dpe">
              <h3 className="result-dpe-title">Score consommation énergie</h3>
              <ResultDPE {...prediction} />
            </div>
            <div className="result-ges">
              <h3 className="result-ges-title">
                Score GES (Gaz à Effet de Serre)
              </h3>
