    ...
    <main className="predict-form">
      ...
      {prediction && (
        <section>
          ...
          <p>
            Ce diagnostic évalue la consommation énergétique et les émissions de
            gaz à effet de serre d'un logement. Un logement performant consomme
            moins d'énergie et émet moins de CO₂, contribuant ainsi à la
            protection de l'environnement.
          </p>
          <p>
            Les niveaux de consommation énergétique et d'émissions de gaz à
            effet de serre dépendent de l'isolation du logement et de
            l'efficacité des équipements. Pour obtenir des conseils sur
            l'amélioration de ces performances, consultez les pages 5 à 6.
          </p>
        </section>
      )}
    </main>
